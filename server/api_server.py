...
SANDBOX_VM_IP = os.getenv("SANDBOX_VM_IP", "localhost")
...
async def load_model():
    ...
    global model, feature_extractor, feature_metadata, lstm_detector, lstm_metadata
...
async def scan_file_detailed(
    ...
    basic_result = await scan_file(file)
